    ...
    buttonCallback(this, &FreqGraphViewBase::buttonCallbackHandler)
{
    ...
    dynamicGraph1MajorXAxisLabel.setLabelTypedText(touchgfx::TypedText(T_SINGLEUSEID307));
    ...
    dynamicGraph1MajorYAxisLabel.setLabelTypedText(touchgfx::TypedText(T_SINGLEUSEID308));
    ...
    dynamicGraph1Histogram1.setColor(touchgfx::Color::getColorFromRGB(194, 23, 23));
