...
void ResultFreqStampsInit(ResultStampsCalcFreq_t *pResultStampsCalcFreq)
{
	...
	memset(pResultStampsCalcFreq->parameters1.measureBuffer, 0, 285 * sizeof(pResultStampsCalcFreq->parameters1.measureBuffer[0]));
	...
	memset(pResultStampsCalcFreq->parameters2.measureBuffer, 0, 285 * sizeof(pResultStampsCalcFreq->parameters2.measureBuffer[0]));
	...
	memset(pResultStampsCalcFreq->parameters3.measureBuffer, 0, 285 * sizeof(pResultStampsCalcFreq->parameters3.measureBuffer[0]));
	...
	memset(pResultStampsCalcFreq->parameters4.measureBuffer, 0, 285 * sizeof(pResultStampsCalcFreq->parameters4.measureBuffer[0]));
	...
	memset(pResultStampsCalcFreq->parameters5.measureBuffer, 0, 285 * sizeof(pResultStampsCalcFreq->parameters5.measureBuffer[0]));
	...
	memset(pResultStampsCalcFreq->parameters6.measureBuffer, 0, 285 * sizeof(pResultStampsCalcFreq->parameters6.measureBuffer[0]));
	...
	memset(pResultStampsCalcFreq->parameters7.measureBuffer, 0, 285 * sizeof(pResultStampsCalcFreq->parameters7.measureBuffer[0]));
	...
	memset(pResultStampsCalcFreq->parameters8.measureBuffer, 0, 285 * sizeof(pResultStampsCalcFreq->parameters8.measureBuffer[0]));
}
